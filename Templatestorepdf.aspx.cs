...
public partial class Templatestorepdf : System.Web.UI.Page
{
    ...
    protected void lnk_openIE_Click(object sender, EventArgs e)
    {
        ...
        else if (TreeView1.CheckedNodes.Count == 1)
        {
            ...
            if (TreeView1.CheckedNodes.Count > 0 && TreeView1.CheckedNodes.Count < 2)
            {
                ...
                { formFieldMap["txtDoctor"] = "Dr. Upendra Sinhas"; }
                ...
                formFieldMap["txt_admitting_surgeon"] = " Dr. Upendra Sinhas";
    ...
    public static string[] getFirstName(string prefix)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                name = ds.Tables[0].Rows[i]["LastName"].ToString() + " " + ds.Tables[0].Rows[i]["FirstName"].ToString();
        ...
        protected void txt_name_TextChanged(object sender, EventArgs e)
    {
        ...
        string id = hfpatientId.Value;

        //if (!string.IsNullOrEmpty(hfpatientId.va))
        //{
        ...
        if (!string.IsNullOrEmpty(txt_name.Text))
        {
            ...
            if (string.IsNullOrEmpty(hfpatientId.Value))
                ...
                LoadPatientIE("WHERE Patient_ID=" + hfpatientId.Value, 1);
        }
