...
public partial class PatientIntakeList : System.Web.UI.Page
{
    ...
    protected void lnkprint_Click(object sender, EventArgs e)
    {
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                work_status = work_status + gender + " had an  injury in " + page1_accident["txt_injur_past_bp"] + " because of the  " + page1_accident["txt_injur_past_how"].TrimEnd('.') + ". ";
            }
        ...
        string strRos = "", strRosDenis = "", strComplain = "", strDOD = "", strRestriction = "", strWorkStatus = "", strMedi = "";
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (!string.IsNullOrEmpty(strprocedures))
            {
                ...
                str = str.Replace("#precautions", string.IsNullOrEmpty(sb.ToString().TrimStart(',')) ? "" : "<b>PRECAUTIONS: </b>" + (sb.ToString().TrimStart(',').TrimEnd('.')) + ".<br/><br/>");
            }
            else
            {
            ...
            str = str.Replace("#consultation", string.IsNullOrEmpty(sb.ToString().TrimStart(',')) ? "" : "<b>CONSULATION: </b>" + sb.ToString().TrimStart(',') + ".<br/><br/> ");
        ...
        str = str.Replace("#plan", string.IsNullOrEmpty(strPlan) ? "" : "<b>PLAN:</b><br/>" + strPlan + "<br/><br/>");
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["PEvalue"].ToString()))
            {
                ...
                shoulderPE = shoulderPE.Replace("Positive for,", "Positive for").Replace("Positive for and ", "Positive for");
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["PEvalue"].ToString()))
            {
                ...
                kneePE = kneePE.Replace("Positive for,", "Positive for").Replace("Positive for and ", "Positive for");
            }
    ...
    public string printPage1(string patientIE_ID)
    {
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (page1["rdbhospyes"] == "true")
            {
                ...
                if (page1["rdbwhospno"] == "true")
                    str = str + " on same day the accident occurred ";
                else
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (ds.Tables[0].Rows[0]["LeftShoulder"].ToString() == "True" && ds.Tables[0].Rows[0]["RightShoulder"].ToString() == "True")
                strbodypart = strbodypart + ", bilateral shoulder";
            else
            {
