...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                      ...
                      <div id="McCaseIns" >
                            <div class="col-md-4" style="width:24%;float:left;margin-left:10px">
                                ...
                                <div id="McOpt" style="visibility: collapse">
                                    <div id="McDatediv">
                                        <label id="ScDate" class="align boldertext" style="width:70px">MC Date</label>
                                        <input type="text" id="McDate" class="date" style="margin-left: 55px;width:80px" />
                                    </div>
                                    <div >
    ...
    <input id="CTLbl" type="hidden" runat="server"   />                
    </div>
    <%--<h2>Neck</h2>--%>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            //}
            debugger
            var ctreeportstatus = !($("#<%=CTLbl.ClientID%>").val() == "WC") ? "" : $('#CtStatus').val()
        ...
        function Popup(t) {
            ...
            if ($("#<%= CTLbl.ClientID%>").val() == "WC"  && t[0].dataset.position != "Execute") {
