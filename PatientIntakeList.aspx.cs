...
public partial class PatientIntakeList : System.Web.UI.Page
{
    ...
    protected void lnkprint_Click(object sender, EventArgs e)
    {
        ...
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            str = str.Replace("#location", ds.Tables[0].Rows[0]["Address"].ToString() + "<br/>" + ds.Tables[0].Rows[0]["City"].ToString() + ", " + ds.Tables[0].Rows[0]["State"].ToString() + " " + ds.Tables[0].Rows[0]["Zip"].ToString());
        ...
        if (!string.IsNullOrEmpty(strDaignosis))
        {
            ...
            str = str.Replace("#diagnoses", "<b>FINAL DIAGNOSES: </b>" + strDaignosis + "<br/><br/>");
        }
        else
                ...
                if (!string.IsNullOrEmpty(str[i]))
                {
                    ...
                    else
                    {
                        if (string.IsNullOrEmpty(strVal))
                            ...
                            strVal = strVal + "<br/><br/>" + str[i].TrimStart('@');
                    }
                }
            }
