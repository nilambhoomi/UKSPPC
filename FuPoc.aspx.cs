...
public partial class FuPoc : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string Save(long ProcedureDetailID, long ProcedureMasterID, long _patientIEID, long? _patientFUID, string SubProcedureID, string BodyPart, long ProcedureID, string Medication, string Muscle, string Level, string Position, string date, string req, int BodyPartID, int IsFromNew, int? PatientProcedureID, Int16 IsConsidered, string Side, string BlobStr = "", string MC_Type = "", string MC_Date = "", string MC_Report_Status = "", string MC_Note = "", string MC_ReSche_Date = "", string CT_AUTH_Date = "", string CT_Report_Status = "", string CT_Note = "", string CT_ReSche_Date = "", string Ins_Ver_Status = "", string Backup_Line = "", string Ins_Note = "", string IsVaccinated = "", string Vac_Status = "", string Vac_Note = "")
    {
        FuPoc _bl = new FuPoc();
...
then BodypartSide
    ...
    public string savePatientProcedureDetailNew(long ProcedureDetailID, long ProcedureMasterID, long _patientIEID, long? _patientFUID, long BodyPartID, long? ProcedureID, DateTime? Consider, DateTime? Requested, DateTime? Scheduled, DateTime? Followup, DateTime? Executed, string BodyPart, string Medication, string Muscle, string Level, string Req_Pos, string Sch_Pos, string Exe_Pos, string FU_Pos, int CreatedBy, int IsFromNew, int? PatientProcedureID, string req, Int16 IsConsidered, string Side, string SubCode, string SignPath = null, string BodypartSide = "", string MC_Type = "", string MC_Date = "", string MC_Report_Status = "", string MC_Note = "", string MC_ReSche_Date = "", string CT_AUTH_Date = "", string CT_Report_Status = "", string CT_Note = "", string CT_ReSche_Date = "", string Ins_Ver_Status = "", string Backup_Line = "", string Ins_Note = "", string IsVaccinated = "", string Vac_Status = "", string Vac_Note = "")
    {
        ...
        if (MC_Report_Status != "Denied")
        {
            MC_Note = "";
            MC_ReSche_Date = "";
        }
        if (CT_Report_Status != "Denied")
        {
            CT_Note = "";
            CT_ReSche_Date = "";
        }
        if (Ins_Ver_Status == "Yes")
        {
            Ins_Note = "";
            Backup_Line = "";
        }
        ...
        setParamValue(ref param, "@MC_Type", MC_Type);
        setParamValue(ref param, "@MC_Date", MC_Date);
        setParamValue(ref param, "@MC_Report_Status", MC_Report_Status);
        setParamValue(ref param, "@MC_Note", MC_Note);
        setParamValue(ref param, "@MC_ReSche_Date", MC_ReSche_Date);
        setParamValue(ref param, "@CT_AUTH_Date", CT_AUTH_Date);
        setParamValue(ref param, "@CT_Report_Status", CT_Report_Status);
        setParamValue(ref param, "@CT_Note", CT_Note);
        setParamValue(ref param, "@CT_ReSche_Date", CT_ReSche_Date);
        setParamValue(ref param, "@Ins_Ver_Status", Ins_Ver_Status);
        setParamValue(ref param, "@Backup_Line", Backup_Line);
        setParamValue(ref param, "@Ins_Note", Ins_Note);
        setParamValue(ref param, "@IsVaccinated", IsVaccinated);
        setParamValue(ref param, "@Vac_Status", Vac_Status);
        setParamValue(ref param, "@Vac_Note", Vac_Note);


        //param.Add(new SqlParameter("@MC_Date", MC_Date));
        //param.Add(new SqlParameter("@MC_Report_Status", MC_Report_Status));
        //param.Add(new SqlParameter("@MC_Note", MC_Note));
        //param.Add(new SqlParameter("@MC_ReSche_Date", MC_ReSche_Date));
        //param.Add(new SqlParameter("@CT_AUTH_Date", CT_AUTH_Date));
        //param.Add(new SqlParameter("@CT_Report_Status", CT_Report_Status));
        //param.Add(new SqlParameter("@CT_Note", CT_Note));
        //param.Add(new SqlParameter("@CT_ReSche_Date", CT_ReSche_Date));
        //param.Add(new SqlParameter("@Ins_Ver_Status", @Ins_Ver_Status));
        //param.Add(new SqlParameter("@Backup_Line", Backup_Line));
        //param.Add(new SqlParameter("@Ins_Note", Ins_Note));
    ...
    void setParamValue(ref List<SqlParameter> param, string paramname, string value)
    {
        if (value != "")
        {
            try
            {
                if (paramname == "@Ins_Ver_Status")
                {
                    if (value == "Yes")
                        param.Add(new SqlParameter(paramname, true));
                    else
                        param.Add(new SqlParameter(paramname, false));
                }
                else if (paramname == "@IsVaccinated")
                {
                    if (value == "Yes")
                        param.Add(new SqlParameter(paramname, true));
                    else
    ...
    [WebMethod]
    public static string GetProcDetail(long ProcedureDetailID)
    {
        DataAccess _dal = new DataAccess();
        DataTable dt = new DataTable();
        List<SqlParameter> param = new List<SqlParameter>();
        param.Add(new SqlParameter("@ProcedurrDetail_ID", ProcedureDetailID));

        DataTable data = _dal.getDataTable("nusp_getProcedureDetailsNew", param);
        string json = JsonConvert.SerializeObject(data);
        return json;
    }

    public void getCaseType(long patientIEID)
    {
        DataAccess _dal = new DataAccess();
        DataTable dt = new DataTable();
        List<SqlParameter> param = new List<SqlParameter>();
        ...
        DataTable data = _dal.getDataTable("nusp_GetPatientDetails", param);
        CTLbl.Value= data.Rows[0]["Compensation"].ToString(); 
    }
