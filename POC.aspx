...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="modal fade" id="SelectPopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;width:980px;margin-left:-490px;">
                ...
                <div class="modal-body" style="height:700px">
                    <form id="MedForm" class="">
                        ...
                        <div class="col-lg-3">
                            ...
                            <%--</select>--%>
                            <input type="text" style="margin-left: 60px" id="PositionValue" readonly="true" />
                        ...
                        <div class="col-lg-3">
                            ...
                            <input type="text" id="date" class="date" style="margin-left: 82px" />
                        </div>
                        <br />  
                        <div id="McCaseIns" >
                            <div class="col-md-4" style="width:24%;float:left;margin-left:10px">
                                <div >
                                    <label id="MClbl" class="align boldertext" style="width: 100px">MC </label>
                                    <select id="McType" style="margin-left: 90px;width:90px" onchange="showMC(this)">
                                ...
                                <div id="McOpt" style="visibility: collapse">
                                    <div id="McDatediv">
                                        <label id="ScDate" class="align boldertext">MC Date</label>
                                        <input type="text" id="McDate" class="date" style="margin-left: 55px;width:100px" />
                                    </div>
                                    <div >
                                        <label id="ObReport" class="align boldertext">Obtain Reports</label>
                                        <select id="McStatus" style="margin-left: 15px;width:100px" onchange="showReports(this)">
                                    ...
                                    <div id="Obreport" style="visibility: collapse">
                                        <div >
                                            <label id="Notelbl" class="align boldertext">Note</label>
                                            <br />
                                            <%--<input type="text"  value="" id="McNote" />--%>
                                             <textarea  id="McNote" style="width:215px;height:100px"></textarea> 
                                        </div>

                                        <div  id="ReDate">
                                            <label id="ReDateLbl" class="align boldertext">Reschedule Date</label>
                                            <input type="text" id="McReDate" class="date" style="margin-left: 5px;width:100px" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4" style="width:24%;float:left;margin-left:10px">
                                ...
                                <div id="Auth">  
                                    <div id="CtDatediv">
                                        <label id="ctDate" class="align boldertext">WC auth Date</label>
                                        <input type="text" id="CtDate" class="date" style="margin-left: 15px;width:100px" />
                                    </div>
                                    
                                    <div >
                                        <label id="AuthSub" class="align boldertext">Auth Status</label>
                                    ...
                                    <div id="AuthCal" style="visibility: collapse">
                                        ...
                                        <div >
                                            <label id="ANotelbl" class="align boldertext">Note</label>
                                            <br />
                                            <%--<input type="text" value="" id="CtNote" />--%>
                                            <textarea  id="CtNote" style="width:215px;height:100px"></textarea> 
                                        </div>

                                        <div class="col-lg-3" id="AuthDate">
                                            <label id="ReDate" class="align boldertext">Reschedule Date</label>
                                            <input type="text" id="CtReDate" class="date" style="margin-left: 5px;width:100px" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4" style="width:23%;float:left;margin-left:10px"  >

                                <div id="Ins">
                                    <div class="col-lg-3">
                                        <label id="InsVerLbl" class="align boldertext">Ins Verification</label>
                                        <select id="InsVerCmb" style="margin-left: 15px;width:100px" onchange="showIns(this)">
                                            <option value="Yes">Yes</option>
                                            <option value="No">No</option>
                                        </select>
                                    </div>
                                    <div id="InsVer" style="visibility:collapse">
                                        <label id="InsVerCon" class="align boldertext">Backup Lien</label>
                                        <select id="InsVerCof" style="margin-left: 15px;width:100px">
                                            <option value="Pending">Pending</option>
                                            <option value="Received">Received</option>
                                        </select>
                                        <br />
                                        <div >
                                            <label id="INotelbl" class="align boldertext">Note</label>
                                            <br />

                                            <%--<input type="text" value="" id="InsNote" />--%>
                              ...
                              <div class="col-md-4" style="width:23%;float:left;margin-left:10px"  >
                                ...
                                <div id="Vac">
                                    <div class="col-lg-3">
                                        <label id="VacLbl" class="align boldertext">Vacinated</label>
                                    ...
                                    <div id="VacStatus" style="visibility:collapse">
                                        <label id="VacStatusLbl" class="align boldertext">Status</label>
                                        ...
                                        <br />
                                        <div >
                                            <label id="VacNotelbl" class="align boldertext">Note</label>
                                            <br />
    ...
    <script type="text/javascript">
        ...
        function Popup(t) {
            ...
            if ($("#ctl00_CTLbl").html() == "WC"  && t[0].dataset.position != "Execute") {
        ...
        function EditProc() {
            ...
            if ($('#hfExecute').val()) {
                ...
                $.ajax({
                    ...
                    //url: "POC.aspx/GetSubCodeFromDB",
                    //data: "{'SubCode':'" + t[0].dataset.pid + "'}",
                    url: "POC.aspx/GetProcDetail",
                    data: "{'ProcedureDetailID':'" + $('#ProcedureDetailId').val() + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "JSON",
                    success: function (output) {
                        debugger

                        data = JSON.parse(output.d)[0];
                        $('#McType').val(data.MC_Type);
                        if (data.MC_Report_Status) $('#McStatus').val(data.MC_Report_Status);
                        if (data.MC_Date) $('#McDate').val(new Date(data.MC_Date).toLocaleDateString("en-US"));
                        $('#McNote').val(data.MC_Note);
                        if (data.MC_ReSche_Date) $('#McReDate').val(new Date(data.MC_ReSche_Date).toLocaleDateString("en-US"));
                        if (data.CT_AUTH_Date) $('#CtDate').val(new Date(data.CT_AUTH_Date).toLocaleDateString("en-US"));
                        if (data.CT_Report_Status) $('#CtStatus').val(data.CT_Report_Status);
                        $('#CtNote').val(data.CT_Note);
                        if (data.CT_ReSche_Date) $('#CtReDate').val(new Date(data.CT_ReSche_Date).toLocaleDateString("en-US"));
    ...
    //var MCDate = $('#McDate').val();
        ...
        function setDefault()
        {
              var days = 7;
                ...
                var mcdate = new Date(date.getTime() + (prev * 24 * 60 * 60 * 1000)).toLocaleDateString("en-US");
                var redate = new Date(date.getTime() + (days * 24 * 60 * 60 * 1000)).toLocaleDateString("en-US");
                //if ($("#McDate").val()=="")
                 //   $("#McDate").val(mcdate);
                //$("#CtDate").val(date.toLocaleDateString("en-US"));
                //$("#McReDate").val(redate);
               // $("#CtReDate").val(redate);
                  if ($("#McDate").val()=="")
                        $("#McDate").val(mcdate);
                    $("#McType").val('No')
                    $("#CtDate").val('')
                    $("#CtStatus").val('Pending')
                    $("#McStatus").val('Pending')
                    $("#McNote").val('')
                    $("#CTNote").val('')
                    $("#InsNote").val('')            
                    $('#InsVerCof').val('Pending');
                    $("#InsVerCmb").val("Yes");
            $("#VacNote").val('');
            $("#VacStatus").val('Pending');
                    $("#VacCmb").val("No");
                            showMC(document.getElementById('McType'));
                            showReports(document.getElementById('McStatus'));
                            showAuth(document.getElementById('CtStatus'));
